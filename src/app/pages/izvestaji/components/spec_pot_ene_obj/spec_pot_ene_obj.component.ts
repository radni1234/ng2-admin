...
export class IzvSpecPotEneObj implements OnInit {
  ...
  convert(){
    ...
    doc.text(40, 10, "Specifična potrošnja energenata po objektima" + "\nza period: "+ this.period);
...
//
    ...
    anchor.download = "specificna_potrosnja_energenata_po_objektima.xls";
    anchor.click();
