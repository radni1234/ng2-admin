...
import {KotlarnicaPotrosnjaPoKotlarnici} from "./potrosnja_kotlarnica.data";
...
@Component({
  ...
  templateUrl: 'potrosnja_kotlarnica.component.html'
})
export class IzvKotPotKotComponent implements OnInit {
  @ViewChild(MonthYearPicker)
  private m: MonthYearPicker;

  kotlarniceId: any[];

  podaci: KotlarnicaPotrosnjaPoKotlarnici[];
  ...
  formirajIzvestaj(){
    ...
    this.crudService.getData("izvestaj/kot_pot_po_kot?kot_id="+this.kotlarniceId+"&ene_tip_id="+this.eneTipIzbor+"&datum_od="+'01.01.'+this.m.godOd+"&datum_do="+'31.12.'+this.m.godDo).subscribe(
