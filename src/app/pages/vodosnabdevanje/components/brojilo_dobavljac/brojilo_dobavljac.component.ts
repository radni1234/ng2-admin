...
@Component({
  selector: 'isem-brojilo-dobavljac-vodozahvat',
  template: require('./brojilo_dobavljac.component.html')
})
export class BrojiloDobavljacVodozahvatComponent implements OnInit{
  ...
  getData() {
    this.crudService.getSingle("brojilo_vodozahvat/jedan?id="+this.brojiloId).subscribe(
